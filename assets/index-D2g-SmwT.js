...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function cf(){return new nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gu(),fragmentShader:`
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function uf(){return new nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gu(),fragmentShader:`
...
#define LOW_PRECISION`),e}function mb(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===qd?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===kl?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===hi&&(e="SHADOWMAP_TYPE_VSM"),e}function gb(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ks:case Zs:e="ENVMAP_TYPE_CUBE";break;case wa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _b(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Zs:e="ENVMAP_MODE_REFRACTION";break}return e}function vb(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Kc:e="ENVMAP_BLENDING_MULTIPLY";break;case u0:e="ENVMAP_BLENDING_MIX";break;case h0:e="ENVMAP_BLENDING_ADD";break}return e}function xb(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function yb(n,e,t,i){const s=n.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=mb(t),c=gb(t),u=_b(t),h=vb(t),f=xb(t),d=ab(t),g=lb(r),_=s.createProgram();let m,p,E=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Tr).join(`
`)),o=Cc(o),o=Mf(o,t),o=Sf(o,t),a=Cc(a),a=Mf(a,t),a=Sf(a,t),o=bf(o),a=bf(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const w=E+m+o,M=E+p+a,D=vf(s,s.VERTEX_SHADER,w),P=vf(s,s.FRAGMENT_SHADER,M);s.attachShader(_,D),s.attachShader(_,P),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function L(I){if(n.debug.checkShaderErrors){const O=s.getProgramInfoLog(_).trim(),G=s.getShaderInfoLog(D).trim(),Z=s.getShaderInfoLog(P).trim();let ae=!0,ee=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(ae=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,D,P);else{const se=yf(s,D,"vertex"),j=yf(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
